...
%         end
        ...
        while true
            if rigidBody
                [missedMarkers, markerTable] = avicon.LabelMissedMarkersRigidBody2(vicon, subject, 'MarkerTable', markerTable, 'SegmentMarkers', segmentMarkerStruct, labelMissedMarkersOpts{:});
                rigidBody = false;
                runStart = true;
            else
